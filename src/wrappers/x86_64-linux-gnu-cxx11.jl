...
export libvtkIOLegacy, libvtkImagingGeneral, libvtkIOImage, libvtklzma, libvtkCommonColor, libvtksys, libvtkjpeg, libvtkImagingSources, libvtkRenderingOpenGL2, libvtkParallelCore, libvtkRenderingVolumeOpenGL2, libvtkFiltersExtraction, libvtkRenderingContextOpenGL2, libvtkInteractionStyle, libvtkCommonExecutionModel, libvtkImagingCore, libvtkRenderingVolume, libvtkRenderingContext2D, libvtkFiltersModeling, libvtkCommonSystem, libvtkRenderingCore, libvtkCommonMisc, libvtkCommonComputationalGeometry, libvtkogg, libvtkInteractionWidgets, libvtkRenderingAnnotation, libvtkIOCore, libvtkIOMovie, libvtkCommonMath, libvtkFiltersGeometry, libvtkCommonTransforms, libvtkFiltersStatistics, libvtkFiltersSources, libvtkFiltersHybrid, libvtkImagingColor, libvtkFiltersFlowPaths, libvtkImagingFourier, libvtkImagingHybrid, libvtkIOXMLParser, libvtkmetaio, libvtkCommonDataModel, libvtkImagingMath, libvtkFiltersCore, libvtkIOXML, libvtktheora, libvtkCommonCore, libvtkdoubleconversion, libvtkFiltersGeneral, libvtkDICOMParser, libvtkRenderingFreeType
...
# Relative path to `libvtklzma`
const libvtklzma_splitpath = ["lib64", "libvtklzma.so"]

# This will be filled out by __init__() for all products, as it must be done at runtime
libvtklzma_path = ""

# libvtklzma-specific global declaration
# This will be filled out by __init__()
libvtklzma_handle = C_NULL

# This must be `const` so that we can use it with `ccall()`
const libvtklzma = "libvtklzma.so.1"
...
# Relative path to `libvtkjpeg`
const libvtkjpeg_splitpath = ["lib64", "libvtkjpeg.so"]

# This will be filled out by __init__() for all products, as it must be done at runtime
libvtkjpeg_path = ""

# libvtkjpeg-specific global declaration
# This will be filled out by __init__()
libvtkjpeg_handle = C_NULL

# This must be `const` so that we can use it with `ccall()`
const libvtkjpeg = "libvtkjpeg.so.1"
...
function __init__()
    ...
    foreach(p -> append!(PATH_list, p), (GLEW_jll.PATH_list, Xorg_libXi_jll.PATH_list, Xorg_libXtst_jll.PATH_list, Xorg_libXt_jll.PATH_list, Xorg_libICE_jll.PATH_list, Xorg_libSM_jll.PATH_list, Libtiff_jll.PATH_list, libpng_jll.PATH_list, Zlib_jll.PATH_list, FreeType2_jll.PATH_list, Expat_jll.PATH_list, Lz4_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (GLEW_jll.LIBPATH_list, Xorg_libXi_jll.LIBPATH_list, Xorg_libXtst_jll.LIBPATH_list, Xorg_libXt_jll.LIBPATH_list, Xorg_libICE_jll.LIBPATH_list, Xorg_libSM_jll.LIBPATH_list, Libtiff_jll.LIBPATH_list, libpng_jll.LIBPATH_list, Zlib_jll.LIBPATH_list, FreeType2_jll.LIBPATH_list, Expat_jll.LIBPATH_list, Lz4_jll.LIBPATH_list,))
    ...
    global libvtklzma_path = normpath(joinpath(artifact_dir, libvtklzma_splitpath...))

    # Manually `dlopen()` this right now so that future invocations
    # of `ccall` with its `SONAME` will find this path immediately.
    global libvtklzma_handle = dlopen(libvtklzma_path)
    push!(LIBPATH_list, dirname(libvtklzma_path))
    ...
    global libvtkjpeg_path = normpath(joinpath(artifact_dir, libvtkjpeg_splitpath...))

    # Manually `dlopen()` this right now so that future invocations
    # of `ccall` with its `SONAME` will find this path immediately.
    global libvtkjpeg_handle = dlopen(libvtkjpeg_path)
    push!(LIBPATH_list, dirname(libvtkjpeg_path))

...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import VTKMinimal_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("529833da-d7f1-5821-aee9-3785d4589272"))
platforms = [Pkg.Artifacts.unpack_platform(e, "VTKMinimal", artifacts_toml) for e in artifacts["VTKMinimal"]]
...
if best_platform === nothing
    @debug("Unable to load VTKMinimal; unsupported platform $(triplet(platform_key_abi()))")
else
